document.addEventListener('DOMContentLoaded', () => {
    ...
    const plants = [
        ...
        { id: 'dracaena', name: 'Dracaena', scientificName: 'Dracaena marginata', location: 'Plant Stand', image: 'https://anythinggrowsalberta.com/wp-content/uploads/2022/07/Tropical-House-Plants-21.jpg', symbols: ['🐌', '🔔'], light: 'Bright light (Grow Light)', water: 'Allow top soil to dry. Pot doesn\'t drain well - water sparingly!', soil: 'Well-draining potting mix.', wateringFrequencyDays: 18, lastWatered: null },
